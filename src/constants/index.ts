...
export const rules = [
    ...
    { key: 10, rule: "Cambridge Furs and Generative AI", reason:"Generative AI and 'creative' works produced by it is not permitted within any of the Cambridge Furs groups.", subreasons: ["This includes (but is not limited to) images generated by MidiJourney, Dall-e, Stable Diffusion, stories generated through ChatGPT and others.", "The furry community is one which has a long history with creative people, and the Cambridge furs group is no different. Generative AI which has been trained on users works without their consent, renumeration, or any respect for copyright is not something that we support or wish to allow."] }
];
