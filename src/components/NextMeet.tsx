  ...
  return (
    <div className={`${styles.flexCenter} sm:my-0 my-10 max-w-[400px] rounded dark:bg-black-gradient bg-orange-gradient p-[2px] `}>
        <div className='mx-5 my-5'>
            {nextMeet ? (
                <p className='dark:text-white text-blackfont-poppins'>
                ...
                <p className='dark:text-white text-black font-poppins'>No meets are scheduled yet! Check back shortly for more to be announced!</p>
            )}
        </div>
    </div>
  );
